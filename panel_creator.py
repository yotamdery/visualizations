...
def update_additional_figure(show_figure, selected_model, selected_metrics, selected_segments, filter_non_compliant, filter_compliant, show_objf):
    if 'show' in show_figure:
        fig = create_metrics_compliant_constraints_fig(selected_model, selected_metrics, selected_segments, filter_non_compliant, filter_compliant, show_objf)
